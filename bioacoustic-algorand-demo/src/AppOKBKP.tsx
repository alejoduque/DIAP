...
const BioacousticTokenizationDemo: React.FC = () => {
  ...
  const getCalculationSteps = (rec: Recording): CalculationStep[] => [
    {
      id: 'duration',
      name: 'Análisis de Duración del Audio',
      value: Math.floor(rec.duration / 30),
      description: `Grabación de ${rec.duration}s procesada mediante algoritmo de segmentación temporal`,
    ...
    {
      id: 'metadata',
      name: 'Puntuación de Integridad de Metadatos',
      value: rec.metadataComplete ? 1.8 : 1.0,
      description: 'Modelo de aprendizaje automático evalúa la riqueza de datos y valor científico',
    ...
    {
      id: 'location',
      name: 'Detección de Zona de Biodiversidad',
    ...
    },
    {
      ...
      description: 'Integración con API de Lista Roja UICN y pipeline de identificación de especies',
    ...
    },
    {
      ...
      description: 'Modelo de aprendizaje profundo analiza dominio de frecuencia para reducción de ruido y claridad',
  ...
  const startCalculation = (selectedRecording: Recording) => {
    ...
    steps.forEach((step, index) => {
      setTimeout(() => {
        ...
        setTimeout(() => {
          setShowModal(step.id);
        }, 200);
        
        // Hide modal and complete step
        setTimeout(() => {
          setShowModal(null);
      ...
      }, index * 3500); // Sequential timing: 0ms, 3500ms, 7000ms, etc.
    });
  };
  ...
  useEffect(() => {
    // Modal logic is now handled directly in startCalculation
  }, []);
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 mt-6 text-xl">
            Tokenización por redes neuronales de grabaciones de biodiversidad
          </p>
        </div>
        ...
        {animationPhase === 'complete' && (
          <div className="flex flex-col items-center justify-center min-h-96">
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-10 shadow-2xl border border-white/20 max-w-lg w-full text-center animate-scale-in">
              ...
              <h2 className="text-3xl font-bold mb-4 text-white">Análisis Completo</h2>
              <div className="text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-blue-500">
                {finalTokens}
              </div>
              <p className="text-xl text-gray-300 mb-8">BIOTOKEN acuñado</p>
